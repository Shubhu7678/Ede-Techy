...
const ExploreMore = () => {
  ...
  return (
    <div className="">
      <div className="text-4xl w-[80%] md:w-full text-center mx-auto  font-semibold" >
        Unlock the <HighlightText text={"Power of Code"} />
      </div>
      <p className="text-richblack-300 text-center text-base font-medium mt-3" >Learn to Build anything you can imagine</p>
      <div className="mt-4 hidden md:block md:w-fit  text-center mx-auto" >
        ...
        <div className={`flex flex-col md:flex-row gap-6 mt-12 mb-12 mx-auto w-[80%] h-full `} >
          {
