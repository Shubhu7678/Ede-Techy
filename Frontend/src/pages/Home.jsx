        ...
        <div>
            ...
            <div className="bg-pure-greys-5 text-richblack-700">
                <div className="homepage_bg h-[100px]" >
                    <div className="relative w-11/12 mx-auto max-w-maxContent h-[100px] flex justify-center items-center ">
                        <div className="flex gap-4 px-2 md:gap-10  text-white ">
                            <CTAButton active={true} linkto="/signup" >
                ...
                <div className="w-11/12 mx-auto flex flex-col items-center gap-5 justify-between max-w-maxContent">
                    <div className="flex flex-col md:flex-row gap-12 mt-28 mb-10">
                        <div className="w-[90%] md:w-[45%] text-4xl font-semibold ">Get the skills you need for a <HighlightText text={"job that is in demand."} /> </div>
                        <div className="w-[90%] md:w-[40%] flex flex-col gap-7 items-start">
